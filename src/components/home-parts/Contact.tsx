                    ...
                    <div className={'flex gap-5 w-full'}>
                        <input value={name} onChange={(e) => {
                            setName(e.target.value)
                               ...
                               className={`w-1/2 text-white border-r-0 bg-background border-b-2 ${errors.find((error) => error.for === "name") ? 'border-b-red-500' : 'border-b-white'} px-2 py-2 outline-0 focus:border-yellow transition-all`}
                               placeholder={'Ime'} type="text"/>
                        <input value={surname} onChange={(e) => {
                            setSurname(e.target.value)
                        }}
                               className={`w-1/2 text-white border-r-0 bg-background border-b-2 ${errors.find((error) => error.for === "surname") ? 'border-b-red-500' : 'border-b-white'} px-2 py-2 outline-0 focus:border-yellow transition-all`}
